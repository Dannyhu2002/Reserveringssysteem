...
//    }
    ...
    $reserveren = [
        ...
        $query = "UPDATE `reserveringssysteem`
                  SET naam = '$name', `telefoonnummer` = '$telnr', `mail` = '$mail', `datum` = '$datum', `tijd` = '$time', `personen` = '$personen', `opmerkingen` = '$opmerkingen'
                  WHERE `id` = '$reserverenId'";
...
<form action="<?= $_SERVER['REQUEST_URI']; ?>" method="post" enctype="multipart/form-data">
    <div class="data-field">
        ...
        <input id="Uw Naam" type="text" placeholder="Uw Naam" name="naam" value="<?= $reserveren['naam'] ?>" required/>
        <span class="errors"><?= (isset($errors['naam']) ? $errors['naam'] : '') ?></span>
    </div>
    <div class="data-field">
        <label for="Uw Telefoonnummer">Telefoonnummer</label>
        <input id="Uw Telefoonnummer" type="text" placeholder="Uw Telefoonnummer" name="telefoonnummer" value="<?= $reserveren['telefoonnummer'] ?>" required/>
        <span class="errors"><?= isset($errors['telefoonnummer']) ? $errors['telefoonnummer'] : '' ?></span>
    </div>
    <div class="data-field">
        <label for="Uw E-mail">Email</label>
        <input id="Uw Email" type="email" placeholder="Uw E-mail" name="mail" value="<?= $reserveren['mail'] ?>" required/>
    ...
    <div class="data-field">
        ...
        <input id="Aantal Personen" type="number" placeholder="Aantal Personen" name="personen" value="<?= $reserveren['personen'] ?>" required/>
